...
class TestComments(BaseCase):   
    ...
    def test_put_edits_comment_success(self):
        ...
        print("0000000000000000000000000000000000000000000000000")
        # Fetch all comments
        comments = self.session.query(self.Comment).all()

        # Print each comment and its user ID
        for comment in comments:
            print(f"Comment ID: {comment.commentId}, Comment Text: {comment.commentText}, User ID: {comment.userIdUserId}")
        ...
        self.assertEqual(self.USER_ID, comment.userIdUserId)
